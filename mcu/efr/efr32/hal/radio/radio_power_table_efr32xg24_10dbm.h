 ...
 *
 */
#ifndef RADIO_POWER_TABLE_EFR32XG24_10DBM_H_
#define RADIO_POWER_TABLE_EFR32XG24_10DBM_H_
 ...
 * */
const app_lib_radio_cfg_power_t power_table_efr32xg24_10dBm =
{
    .rx_current     = 880,  // 8.8 mA RX current
    .rx_gain_db     = 0,    // 0 dB RX gain
    .power_count    = 6,    // 8 power levels
    .powers =
    {
...
const RAIL_TxPowerConfig_t pa_config_efr32xg24_10dBm =
    {
...
{
    return &power_table_efr32xg24_10dBm;
}
#endif
...
{
    return &pa_config_efr32xg24_10dBm;
}
#endif

#endif /* RADIO_POWER_TABLE_EFR32XG24_10DBM_H_ */
