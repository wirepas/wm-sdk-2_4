 ...
 *
 * Library services are accessed  via [lib_beacon_tx](@ref app_lib_beacon_tx_t)
 * handle.
 *
 ...
 * @note    Stack must be running (i.e. [lib_state->startStack()](@ref app_lib_state_start_stack_f) must have been called) in order for
