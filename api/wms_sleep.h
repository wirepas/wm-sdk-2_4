 ...
 * functionality.
 *
 * Library services are accessed via [lib_sleep](@ref app_lib_sleep_t)
 * handle.
 *
 */
 ...
 *          service [lib_sleep->sleepStackforTime()](@ref app_lib_sleep_stack_for_time_f) has called but device has not yet
 ...
 *
 * Used with [lib_sleep->setOnWakeupCb()](@ref app_lib_sleep_wakeup_callback_f)
 * service
 */
 ...
 * starting from application request [lib_sleep->sleepStackforTime()](@ref app_lib_sleep_stack_for_time_f) until stack enters to NRLS sleep (i.e.
