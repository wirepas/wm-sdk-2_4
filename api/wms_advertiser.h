 ...
 *
 * Library services are accessed  via [lib_advertiser](@ref app_lib_advertiser_t)
 * handle.
 *
 ...
 * with [lib_advertiser->setBeaconDataAckListenCb()](@ref app_lib_advertiser_ackdatacb_f).
 */
#define DIRADV_MAX_ACK_LEN  102

/**
 * \brief   Default value used with [lib_advertiser->setQueuingTimeHp()](@ref app_lib_advertiser_set_queuing_time_f)
 */
 ...
 *              role (service [lib_settings->setNodeRole()](@ref app_lib_settings_set_node_role_f) in order for callback to be
 *              active.
 */
