 ...
 *
 * Library services are accessed  via [lib_beacon_rx](@ref app_lib_beacon_rx_t)
 * handle.
 */
 ...
 *
 * @note   BLE advertising channels 37, 38 and 39 correspond to Wirepas Massive
 *         channels 38, 39 and 40, respectively.
 */
typedef enum
{
 ...
 *         with [lib_beacon_rx->setBeaconReceivedCb()](@ref app_lib_beacon_rx_set_data_received_cb_f) service.
 */
typedef struct
{
 ...
 *          Received packet
 *
 * Used with [lib_beacon_rx->setBeaconReceivedCb()](@ref app_lib_beacon_rx_set_data_received_cb_f) service.
 */
 ...
 *
 * For example on how to use this function, check [lib_beacon_rx->isScannerStarted()](@ref app_lib_beacon_rx_started).
 *
 * @param   channel mask
