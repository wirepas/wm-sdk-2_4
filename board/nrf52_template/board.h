...
/**
 * @brief CTS pin number, for using USART HW flow control.
 */
#define BOARD_USART_CTS_PIN             7
/**
 * @brief RTS pin number, for using USART HW flow control.
 */
 ...
 *
 * @note in order for application to use GPIOs, see [here](@ref source_makefile_hal_gpio).
 */
 ...
 * unconditionally.
 *
 * @note in order for application to use LEDs, see [here](@ref source_makefile_hal_led).
 */
