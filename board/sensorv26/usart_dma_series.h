/* sensorv26 UART series override:
 * UARTE20 (SERIAL20) is in the peripheral domain → P1/P2 pins only.
 * UARTE30 (SERIAL30) is in the LP domain → supports P0 pins (P0.01/P0.00).
 */
...
#define NRF_UARTE0  NRF_UARTE30
#define UART0_IRQn  UARTE30_IRQn
