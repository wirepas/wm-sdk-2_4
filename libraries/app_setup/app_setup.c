    ...
    *lib_settings_keys = (app_lib_settings_key_management_configuration_t)
    {
        ...
        },
        {
            ...
            /* Flag set to 1 if all keys are configured */
            .app_key_management_configured =
            (
                lib_settings_keys->network_key_pair.encryption_key_p &&
                lib_settings_keys->network_key_pair.authentication_key_p &&
                lib_settings_keys->management_key_pair.encryption_key_p &&
                lib_settings_keys->management_key_pair.authentication_key_p
            ) ? 1 : 0,
            .revoke_keys = 0,
            .reserved = 0
        },
