...
# This allow to copy/paste the value with local_provisioning unitary application
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice=="Q":
            ...
            enable_local_provisioning(True, custom_psk_config["custom_psk_id"], custom_psk_config["custom_psk"])
        elif choice=="D":
